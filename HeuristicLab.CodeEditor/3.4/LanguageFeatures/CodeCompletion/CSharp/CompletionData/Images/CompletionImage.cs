...
namespace ICSharpCode.AvalonEdit.CodeCompletion {
  ...
  public class CompletionImage {
    ...
    /// </summary>
    public static ImageSource GetAccessibilityOverlay(ICSharpCode.NRefactory.TypeSystem.Accessibility accessibility) {
      return accessibilityOverlays[GetAccessibilityOverlayIndex(accessibility)];
    }

    static int GetAccessibilityOverlayIndex(ICSharpCode.NRefactory.TypeSystem.Accessibility accessibility) {
    ...
    /// </summary>
    public ImageSource GetImage(ICSharpCode.NRefactory.TypeSystem.Accessibility accessibility, bool isStatic = false) {
